...
public:
    ...
    // write when tag not match
    void writeTagUnmatch(int index, int T)
    {    
    }
...
int main(int argc, char* argv[]){
    ...
    int offset1bit = log2(cacheconfig.L1blocksize);
    int index1bit = log2(cacheconfig.L1size * 1024 / cacheconfig.L1setsize / cacheconfig.L1blocksize);
    int tag1bit = 32 - offset1bit - index1bit;
    
    int offset2bit = log2(cacheconfig.L2blocksize);
    int index2bit = log2(cacheconfig.L2size * 1024 / cacheconfig.L2setsize / cacheconfig.L2blocksize);
    int tag2bit = 32 - offset2bit - index2bit;
